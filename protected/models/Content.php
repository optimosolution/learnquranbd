...
class Content extends CActiveRecord {
    ...
    public static function get_popular() {
        ...
        foreach ($array as $key => $value) {
            echo '<li>' . CHtml::link('<i class="fa fa-sign-out"></i> ' . $value['title'], array('content/view', 'id' => $value['id']), array()) . '</li>';
        }
        echo '</ul>';
    }
    ...
    public static function get_feature() {
        $array = Content::model()->findAll(
                array(
                    'condition' => 'state=1 AND featured=1',
                    'order' => 'created DESC, id DESC',
                    'limit' => '15',
        ));
        echo '<ul class="list-unstyled">';
    ...
    public static function get_feature_home() {
        $array = Content::model()->findAll(
                array(
                    'condition' => 'state=1 AND featured=1',
                    'order' => 'created DESC, id DESC',
        ...
        echo '<ul class="list-unstyled">';
        foreach ($array as $key => $value) {
            echo '<li>' . CHtml::link('<i class="fa fa-sign-out"></i> ' . $value['title'], array('content/view', 'id' => $value['id']), array('style' => 'font-size:14px;')) . ' </li>';
        }
        echo '</ul>';
    }
